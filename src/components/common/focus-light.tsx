...
const FocusLight = () => {
  return (
    <div className="fixed inset-x-0 top-0 bg-bg-light dark:bg-bg-darker md:z-20">
      ...
      <motion.div
        className="mx-auto h-20 w-1/2 rounded-b-full bg-gradient-to-b from-secondary to-transparent blur-3xl dark:from-primary md:hidden"
